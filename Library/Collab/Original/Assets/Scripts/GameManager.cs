...
public class GameManager : MonoBehaviourPunCallbacks
{
    ...
    public static int difficultyLevel = 3; // 1 - easy, 2 - medium, 3 - difficult
    ...
    {
        currentFrozen.enabled = true; // indicate that powerup is being used
        foreach (GameObject ghost in ghosts)
        {
    ...
    IEnumerator ProcessFrozenTime(float delay)
    {
        ...
        currentFrozen.enabled = false; // powerup is not in use anymore
    }
